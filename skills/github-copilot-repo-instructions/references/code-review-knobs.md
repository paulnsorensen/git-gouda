...
## Path-scoped instructions and the character limit (2026-09-23)

Two GitHub changelog posts update the guidance above:

- Copilot code review now reads path-scoped
  `.github/instructions/*.instructions.md` files, not only the repo-wide
  `copilot-instructions.md` (github.blog changelog, 2025-09-03).
- Copilot code review no longer stops reading instruction files at 4000
  characters; that limit is removed (github.blog changelog, 2026-06-12).
...
- [Copilot code review: Path-scoped custom instruction file support (changelog, 2025-09-03)](https://github.blog/changelog/2025-09-03-copilot-code-review-path-scoped-custom-instruction-file-support/)
- [Copilot code review: New configurations and controls (changelog, 2026-06-12)](https://github.blog/changelog/2026-06-12-copilot-code-review-new-configurations-and-controls/)
