...
If `prek` isn't installed, tell the user to install it (`cargo install prek` or `brew install prek`). Keep installation advice scoped to this repository; do not edit personal package manifests or dotfiles.
